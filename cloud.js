  ...
  async function init() {
    ...
    document.querySelector('#auth-form')?.addEventListener('submit', async (event) => {
      ...
      const aliases = {
        ...
        sunliqiang: 'sunliqiang@dfwsgroup.com', wudan: 'wudan@dfwsgroup.com', wangqingqing: 'wangqingqing@dfwsgroup.com', limengcong: 'limengcong@dfwsgroup.com', qiujuan: 'qiujuan@dfwsgroup.com',
